...
class CargoMech():
    ...
    def periodic(self):
        ...
        if self.xbox.getRawButton(map.wristUp) and not self.topSwitch.get(): self.setWrist("up")
        elif self.xbox.getRawButton(map.wristDown) and not self.bottomSwitch.get(): self.setWrist("down")
