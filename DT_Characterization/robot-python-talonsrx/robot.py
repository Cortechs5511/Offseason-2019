...
class MyRobot(wpilib.TimedRobot):
    ...
    def robotInit(self):
        ...
        self.leftEncoder.setDistancePerPulse(6/12 * math.pi / 256)
        self.leftEncoder.setSamplesToAverage(10)

        self.rightEncoder = wpilib.Encoder(2,3)
        self.rightEncoder.setDistancePerPulse(-6/12 * math.pi / 256)
    ...
    def teleopPeriodic(self):
        self.drive.arcadeDrive(-self.lstick.getY(), self.rstick.getX())
    ...
    def autonomousPeriodic(self):
        ...
        l_motor_volts = self.left.getMotorOutputVoltage()
        r_motor_volts = self.right.getMotorOutputVoltage()
